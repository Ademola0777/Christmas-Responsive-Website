...
- Features scroll-triggered animations for enhanced interactivity.
- Implements smooth scrolling across all sections.
- Includes both dark and light theme modes.
- Developed using a mobile-first approach, then optimized for desktop.
- Fully responsive and compatible with all mobile devices, delivering a clean, attractive, and user-friendly interface.
